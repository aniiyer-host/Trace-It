...
|------------------------|-------------------------------------|------------|
| Spoofing               | Fake donor/beneficiary accounts     | Wallet-based auth (SIWS) [NOT IMPLEMENTED] + email OTP [IMPLEMENTED] |
...
| DoS                    | Transaction spam on Solana          | Backend rate limiting per IP [IMPLEMENTED] (wallet-based limiting planned) |
