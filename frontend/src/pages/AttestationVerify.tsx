...
export default function AttestationVerify() {
  ...
  const [attestation, setAttestation] = useState<PublicAttestation | null>(
    null,
  );
      ...
      try {
        ...
        setTimeout(() => {
          ...
          const mockAttestation = {
            ...
            statement:
              "AidIndia Foundation confirms receipt of ₹5,000 donated for Flood Relief – Assam 2025 on 2025-07-08",
            type: "receipt",
          };
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background">
        <div className="space-y-6">
          ...
          <p className="text-muted-foreground">
            No attestation found with the provided ID. Please check the ID and
            try again.
          </p>
          <Button onClick={() => window.history.back()} variant="outline">
            Go Back
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="lg:text-xl text-muted-foreground max-w-2xl mx-auto">
              This attestation has been verified and is stored permanently on
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  <p>
                    <strong>Attestation ID:</strong> {attestation.id}
                  </p>
                  <p>
                    <strong>Type:</strong>{" "}
                  ...
                  <p>
                    <strong>NGO:</strong> {attestation.ngoName}
                  </p>
                  <p>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <p>
                    <strong>Verification Method:</strong> Cryptographic
                    signature verification
                  </p>
                  <p>
                    <strong>Data Integrity:</strong> Tamper-proof and
                    permanently stored
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3 text-sm">
                  <p>
                    ...
                    {attestation.donationId.substring(0, 8)}...
                  </p>
                  <p>
                    <strong>Amount:</strong> ₹
                    {attestation.amount.toLocaleString()}
                  </p>
                  <p>
                    <strong>Campaign:</strong> {attestation.campaignTitle}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                ...
                <ol className="list-decimal list-inside space-y-2 text-sm">
                  <li>
                    Donor makes a donation via traditional payment methods
                    (UPI/Card)
                  </li>
                  <li>
                    Donation is recorded on the blockchain with a unique hash
                  </li>
                  <li>Funds are transferred to the NGO's wallet</li>
                  <li>
                    NGO confirms receipt of funds and signs an attestation
                  </li>
                  <li>
                    Attestation is stored permanently on-chain and cannot be
                    altered
                  </li>
                  <li>
                    Anyone can verify the attestation using this public
                    verification page
                  </li>
                </ol>
              </div>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc list-inside space-y-2 text-sm">
                  <li>
                    <strong>Transparency:</strong> Every donation's journey is
                    visible and verifiable
                  </li>
                  <li>
                    <strong>Accountability:</strong> NGOs must confirm receipt
                    before funds are released
                  </li>
                  <li>
                    <strong>Immutability:</strong> Once stored on-chain,
                    attestations cannot be tampered with
                  </li>
                  <li>
                    <strong>Privacy:</strong> Donor identities are protected
          ...
          <div className="flex justify-center space-x-4">
            ...
            <Button
              onClick={() => {
                window.open(
                  `https://explorer.solana.com/address/${attestation.id}?cluster=devnet`,
                  "_blank",
                );
              }}
              variant="outline"
      ...
      <footer className="bg-muted/5 text-center text-xs text-muted-foreground py-6 border-t border-border/20">
        <div className="container max-w-4xl mx-auto px-4">
          <p>
            TraceIt © {new Date().getFullYear()} — Built for transparent
            charitable giving
          </p>
